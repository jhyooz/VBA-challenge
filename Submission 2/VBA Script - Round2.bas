        ...
        For CurrentRow = 2 To EndRowA
            ...
            ElseIf ws.Cells(CurrentRow, "A").Value <> ws.Cells(CurrentRow + 1, "A").Value Then
               ...
               'MsgBox ("Ending Price = " & PriceEnd & vbCrLf & "Starting Price = " & PriceStart & vbCrLf & "Yearly Change = " & YearlyChange)
                ...
                If ws.Range("K" & Summary_Table_Row).Value < 0 Then ' Conditional Formatting
                    ws.Range("K" & Summary_Table_Row).Interior.Color = RGB(255, 199, 206) 'Set cell background to red
                    Else
                    ws.Range("K" & Summary_Table_Row).Interior.Color = RGB(198, 239, 206) 'Set cell background color to green
                    End If
